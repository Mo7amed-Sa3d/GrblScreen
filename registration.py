...
CAM_OFFSET_X_MM = float(-42.14)     # mm camera is RIGHT of knife (calibrate: measure then set)
CAM_OFFSET_Y_MM = float(16.2)     # mm camera is ABOVE knife (calibrate: measure then set)
