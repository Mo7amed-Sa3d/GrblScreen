...
CAM_OFFSET_X_MM = float(-40.0)     # mm camera is RIGHT of knife (calibrate: measure then set)
CAM_OFFSET_Y_MM = float(14.0)      # mm camera is ABOVE knife (calibrate: measure then set)
