...
CAM_OFFSET_X_MM = float(-41.14)     # mm camera is RIGHT of knife (calibrate: measure then set)
CAM_OFFSET_Y_MM = float(15.2)     # mm camera is ABOVE knife (calibrate: measure then set)
