...
CAM_OFFSET_X_MM = float(-40.6)     # mm camera is RIGHT of knife (calibrate: measure then set)
CAM_OFFSET_Y_MM = float(14.344)     # mm camera is ABOVE knife (calibrate: measure then set)
MM_PER_PIXEL    =  0.005333 # mm/pixel — calculated from 5mm dot diameter
...
SCAN_RESULT_BIAS_X_MM = 0
SCAN_RESULT_BIAS_Y_MM = 0
